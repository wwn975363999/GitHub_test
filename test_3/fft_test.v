...
module fft_test (
	...
	asj_fft_si_sose_so_b_fft_110	asj_fft_si_sose_so_b_fft_110_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_sose_so_b_fft_110_inst.nps = 256,
		asj_fft_si_sose_so_b_fft_110_inst.bfp = 1,
		asj_fft_si_sose_so_b_fft_110_inst.nume = 1,
		asj_fft_si_sose_so_b_fft_110_inst.mpr = 8,
		asj_fft_si_sose_so_b_fft_110_inst.twr = 8,
		asj_fft_si_sose_so_b_fft_110_inst.bpr = 16,
		asj_fft_si_sose_so_b_fft_110_inst.bpb = 4,
		asj_fft_si_sose_so_b_fft_110_inst.fpr = 4,
		asj_fft_si_sose_so_b_fft_110_inst.mram = 0,
		asj_fft_si_sose_so_b_fft_110_inst.m512 = 0,
		asj_fft_si_sose_so_b_fft_110_inst.mult_type = 1,
		asj_fft_si_sose_so_b_fft_110_inst.mult_imp = 0,
		asj_fft_si_sose_so_b_fft_110_inst.dsp_arch = 0,
		asj_fft_si_sose_so_b_fft_110_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_sose_so_b_fft_110_inst.rfs1 = "fft_test_1n256sin.hex",
		asj_fft_si_sose_so_b_fft_110_inst.rfs2 = "fft_test_2n256sin.hex",
		asj_fft_si_sose_so_b_fft_110_inst.rfs3 = "fft_test_3n256sin.hex",
		asj_fft_si_sose_so_b_fft_110_inst.rfc1 = "fft_test_1n256cos.hex",
		asj_fft_si_sose_so_b_fft_110_inst.rfc2 = "fft_test_2n256cos.hex",
		asj_fft_si_sose_so_b_fft_110_inst.rfc3 = "fft_test_3n256cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_sose_so_b_fft_110" >
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="964"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="2"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_DSP" value="4"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_CALC_CYCLES" value="1113"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_BLK_THROUGHPUT_CYCLES" value="1626"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="8192"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP2C8Q208C8"  type="STRING"  enable="1" />
...
// =========================================================
// RELATED_FILES: fft_test.v;
// IPFS_FILES: fft_test.vo;
// =========================================================
